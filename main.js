/**
 * STAGYON — SHOP ENGINE
 * Renders the product grid, filter chips, search and sort.
 * Loaded as a module on every page: <script type="module" src="main.js"></script>
 * Depends on config.js (waLink, formatPrice) and data.js (STAGYON_PRODUCTS, CATEGORY_LABELS).
 */
...
/** Homepage hero: live stock count + budget-enquiry links. */
